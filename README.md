...
можно создать готовое правило. Автодетектор переводов сопоставляет только
неразмеченные равные по модулю `in`/`out` в разных счетах одной валюты. Только однозначная пара в окне
