...
var demoCategories = []demoCategory{
	...
	{"Пожертвования", "#565656", "", "heart-handshake"},
	{"Инвестиции", "#df4e92", "", "chart-line"},
	{"Доход", "#df4e92", "", "calculator"},
	...
	{"КУ", "#e99537", "Дом", "house"},
	{"Мебель", "#e99537", "Дом", "truck"},
	{"Хозтовары", "#e99537", "Дом", "drill"},
	...
	{"Зарплата", "#df4e92", "Доход", "calculator"},
	{"Бонусы", "#df4e92", "Доход", "badge-dollar-sign"},
	{"Проценты по вкладу", "#df4e92", "Инвестиции", "chart-line"},
	{"Дивиденды", "#df4e92", "Инвестиции", "chart-line"},
	{"Обучение", "#626D65", "Образование", "graduation-cap"},
	{"Выпуск статей", "#626D65", "Образование", "graduation-cap"},
	{"Благотворительность", "#565656", "Пожертвования", "heart-handshake"},
	{"Чаевые", "#565656", "Пожертвования", "wallet"},
}
...
var demoUsers = []demoUser{
	{"user1", "Иван Петров", "user1@demo.invalid"},
	{"user2", "Елена Смирнова", "user2@demo.invalid"},
}
...
var demoRules = []demoRule{
	// Расходы
	{"Оплата проезда в метро", "expense", "Общественный транспорт"},
	{"Покупка продуктов в супермаркете", "expense", "Супермаркет"},
	{"Обед в кафе", "expense", "Кафе"},
	{"Ужин в ресторане", "expense", "Рестораны"},
	{"Пополнение счета мобильного", "expense", "Мобильная связь"},
	{"Оплата домашнего интернета", "expense", "Проводной интернет"},
	{"Подписка на видеосервис", "expense", "Подписки"},
	{"Абонемент в фитнес-клуб", "expense", "Фитнес"},
	{"Посещение парикмахерской", "expense", "Парикмахерская"},
	{"Стоматологические услуги", "expense", "Стоматология"},
	{"Покупка лекарств", "expense", "Аптека"},
	{"Оплата обучения", "expense", "Обучение"},
	{"Покупка авиабилетов", "expense", "Авиабилеты"},
	{"Поездка на такси", "expense", "Такси"},
	{"Проезд в автобусе", "expense", "Общественный транспорт"},
	{"Покупка готовой еды", "expense", "Готовая еда"},
	{"Заказ продуктов с доставкой", "expense", "Готовая еда"},
	{"Оплата коммунальных услуг", "expense", "КУ"},
	{"Покупка бытовой техники", "expense", "Электроника"},
	{"Одежда и обувь", "expense", "Одежда"},
	{"Книги и журналы", "expense", "Развлечения"},
	{"Билеты в кино", "expense", "Кино"},
	{"Оплата парковки", "expense", "Транспорт"},
	{"Техническое обслуживание авто", "expense", "Транспорт"},
	{"Страховка", "expense", "Дом"},

	// Доходы
	{"Заработная плата", "income", "Зарплата"},
	{"Кэшбэк за покупки", "income", "Бонусы"},
	{"Проценты по вкладу", "income", "Проценты по вкладу"},
	{"Дивиденды по акциям", "income", "Дивиденды"},
	{"Возврат средств за товар", "income", "Бонусы"},
	{"Премия", "income", "Зарплата"},
	{"Подарок", "income", "Бонусы"},
	{"Возврат налогового вычета", "income", "Зарплата"},
}
...
func buildDemoTransactions(days int) []demoTransaction {
	...
	for offset := 0; offset < days; offset++ {
		...
		if offset%30 == 0 {
			add("salary", offset, "checking", "Зарплата", []string{"Регулярное"}, 185000, "Зарплата")
