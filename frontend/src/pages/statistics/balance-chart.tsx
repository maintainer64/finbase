...
export const BalanceChart: Component<{series: BalanceSeries[]; currency: string; area?: boolean}> = (props) => {
    const option = createMemo<ChartOption>(() => {
        ...
        return {
            ...
            tooltip: {
                ...
                valueFormatter: (value: unknown) => formatMoney(Number(Array.isArray(value) ? value[value.length - 1] : value), props.currency),
