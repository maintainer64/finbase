        ...
        return {
            ...
            tooltip: {
                ...
                formatter: (params: {name?: string; value?: number; percent?: number}) =>
                    `<b>${escapeChartHtml(params.name)}</b><br/>${formatMoney(Number(params.value ?? 0), props.currency)} · ${params.percent ?? 0}%`,
            },
            graphic: [{
                type: "group",
                left: "center",
                ...
                children: [
                    ...
                    {type: "text", style: {text: formatMoney(total, props.currency), x: 0, y: 9, textAlign: "center", fill: dark ? "#f8fafc" : "#0f172a", font: "700 15px Inter, sans-serif"}},
                ],
            }],
            series: [{
                type: "pie",
